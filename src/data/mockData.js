...
export const smartHome = generateProducts(
  ...
  [
    ...
    'Voice Assistant  -  360 degree  Sound',
...
export const reviews = [
  { id: 1, name: 'Arjun Mehta',    avatar: 'AM', rating: 5, review: 'Absolutely premium experience! The Nova X Pro 5G is insanely fast and the display is cinema-grade. Gadget69 packaging alone felt like unboxing a luxury product.', product: 'Nova Pro 5', verified: true,  date: '2 days ago' },
  ...
  { id: 4, name: 'Kavya Nair',     avatar: 'KN', rating: 5, review: 'Pulse Ultra watch is like wearing a piece of the future. Health tracking is accurate, build quality is titanium-grade. Gadget69 customer support is stellar.', product: 'Pulse Ultra', verified: true, date: '1 week ago' },
